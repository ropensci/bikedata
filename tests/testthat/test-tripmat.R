...
test_that ("tripmat-starttime", {
    ...
    expect_silent (tm2 <- bike_tripmat (
        bikedb = bikedb, city = "ny",
        start_time = "1",
        quiet = TRUE
    ))
    expect_silent (tm3 <- bike_tripmat (
        bikedb = bikedb, city = "ny",
        start_time = "01:00",
        quiet = TRUE
    ))
