...
extern SEXP _bikedata_rcpp_import_to_trip_table(SEXP, SEXP, SEXP, SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_bikedata_rcpp_import_to_trip_table", (DL_FUNC) &_bikedata_rcpp_import_to_trip_table, 5},
    {NULL, NULL, 0}
};
